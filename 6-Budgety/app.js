...
var budgetContoller = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            // map returns results in a new array
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        num = Math.abs(num);
        num = num.toFixed(2); //sets to a string with 2 decimal places

        numSplit = num.split('.'); //split the number into the integer and decimal parts
    ...
    return {
        ...
        clearFields: function() {
            ...
            // set the focus back to the first input
            fieldsArr[0].focus();
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var setupEventListeners = function() {
        ...
        document.addEventListener('keypress', function(event) {
            //can use 'keycode' for newer browsers, need to use 'which' for older browsers
    ...
    var ctrlAddItem = function() {
        ...
        if(input.description !== "" & !isNaN(input.value) && input.value > 0) {
            ...
            // 4. Clear the fields and set the focus back to the first input field
            UICtrl.clearFields();
